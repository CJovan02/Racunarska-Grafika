...
{
	double specR = .3, specG = .3, specB = .3;
	double shininess = 32;
...
{
	SetLightPositionAndDirection(GL_LIGHT0, { 15, 0, 0 }, { -1, 0, 0 }, light0On, light0Col);
	SetLightPositionAndDirection(GL_LIGHT1, { 15, 0, 0 }, { -1, 0, 0 }, light1On, light1Col);
	SetLightPositionAndDirection(GL_LIGHT2, { 15, 0, 0 }, { -1, 0, 0 }, light2On, light2Col);
	SetLightPositionAndDirection(GL_LIGHT3, { 15, 0, 0 }, { -1, 0, 0 }, light3On, light3Col);
}
